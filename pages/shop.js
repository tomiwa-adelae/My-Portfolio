         ...
         <div className="case-showcase">
            ...
            <div className="details">
               <div className="intro">
                  ...
                  <h5>An app for buying and selling in school environment</h5>
               </div>
               <div
                  onClick={() => {
                     window.scroll({
               ...
               <div className="bottom-details">
                  <h6>
                     <span className="text-shop-grey">Role</span> Full Stack
                     Developer
                  </h6>
                  <h6>
                     <span className="text-shop-grey">Period</span> Late 2022
                  </h6>
               </div>
            </div>
         </div>
