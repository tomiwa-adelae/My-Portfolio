      ...
      <div className="days">
         ...
         <div className="case-showcase">
            ...
            <div className="details">
               ...
               <div className="bottom-details">
                  ...
                  <h6>
                     <span className="text-gold">Period</span> Middle 2022
                  </h6>
               </div>
            </div>
         </div>
         <div className="about-project">
            <div className="content">
               <h3>The Project</h3>
               <p>
                  D-Day is a Full Stack web application that keeps track of
                  birthdays and sends an email to both the birthday celebrant
                  and you, the user.
               </p>
               <a target="_blank" href="https://d-day.herokuapp.com/">
